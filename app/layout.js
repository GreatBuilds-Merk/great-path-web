  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* Inter = body + UI. Cormorant Garamond = display headings and big
            figures. Cormorant has a small x-height, so it's set larger and at
            600/700 — see the size compensation in globals.css. */}
        <link
