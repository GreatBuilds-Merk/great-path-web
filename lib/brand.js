...
export const TIERS = [
  ...
  },
  {
    ...
    includes: [
      ...
      "Covered by The Great Performance Guarantee",
...
export const POPUP = {
  storageKey: "gp_seen_intro_v1", // bump the version to show it again to everyone
  ...
  guaranteeLead: "And we put money behind it.",
  cta: "Book a 15-minute call",
  secondary: "See pricing and the guarantee",
  dismiss: "No thanks",
};

// --- The Great Performance Guarantee -----------------------------------------
// Deliberately a FEE-VALUE guarantee, not an outcome guarantee. We promise
// something about our own fee, not about their business — that's what keeps it
// consistent with the Terms page (see clause Eighth) and what makes it honest.
//
// Conditions are about PARTICIPATION, never results. A client can't be asked to
// achieve the outcome they hired us to help cause.
//
// Offered on + Insights and + Advisor only. Your Engine has no advisor in the
// loop, so guaranteeing it would mean underwriting a result we can't influence.

export const GUARANTEE = {
  name: "The Great Performance Guarantee",
  hook: "2.5× or 50% back.",
  eligibleTiers: ["advisor"],
  tierNote: "Included with + Advisor.",

  headline: "If it doesn't pay for itself two and a half times over, you get half your money back.",

  promise:
    "Twelve months, twelve working sessions, and a number we agree on before we start. If the measured improvement hasn't reached two and a half times what you paid us, you choose: half your fees refunded, or a credit against the year ahead.",

  honest:
    "To be clear about what this is: we're not promising your business will grow — nobody honest can. We're promising that if we both do the work and it doesn't pay for itself, you shouldn't have paid full price for it.",

  whyAdvisorOnly:
    "It comes with + Advisor because that's the tier with twelve working sessions in it. A guarantee only means something when we're in the room often enough to change the outcome.",

  qualify: [
    "Meet twelve times in twelve months — one working session a month",
    "Reschedule if you need to, but no more than twice in any thirty-day window",
    "Send your numbers each month so there's something to work from",
    "Act on the checkpoint actions — or tell us why you're not",
  ],

  fairness: [
    "If we reschedule, it never counts against you. Only your reschedules count.",
    "If something slips, you hear it from us that week — never for the first time at month thirteen.",
    "Most slips are curable. We'll tell you what it takes to get back on track.",
    "At month six we review progress together, while there's still time to fix it.",
  ],

  measured: [
    "Against the specific checkpoints set at your Path Setup — not your business in general",
    "On gross profit, not revenue — revenue is easy to grow by discounting",
    "Baselined on the twelve months before we started",
    "Reviewed in every session and sent to you in writing after each one",
    "Excluding one-time events: asset sales, acquisitions, insurance payouts",
  ],

  finePrint: [
    "Included with + Advisor. Not offered on Your Engine or + Insights — those tiers don't include the twelve sessions the guarantee depends on.",
    "The claim window opens at month thirteen and closes at month fifteen.",
    "The refund is 50% of recurring fees paid. You choose: money back, or a credit against the following year.",
    "Setup fees are excluded — that work is delivered at the start.",
    "One claim per client, per engagement.",
    "Every definition is agreed in writing at Path Setup, before anything begins.",
  ],

  why:
    "Most advisors won't do this because they can't measure what they delivered. We can — every checkpoint is tracked the same way each month and sent to you in writing, so at the end there's an agreed number rather than an argument.",
};
