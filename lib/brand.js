...
export const GUARANTEE = {
  ...
  hook: "5× or 50% back.",
  eligibleTiers: ["insights", "advisor"],

  headline: "If it doesn't pay for itself five times over, you get half your money back.",

  promise:
    "Stay on the Path for twelve months and do your part. If the measured improvement against the goals we set together hasn't reached five times what you paid us, we refund half your recurring fees. Not many advisors will put that in writing. We will.",

  honest:
    "To be clear about what this is: we're not promising your business will grow — nobody honest can promise that. We're promising that if you do the work and this doesn't pay for itself several times over, you shouldn't have paid full price for it.",

  qualify: [
    "Send your numbers every month, on time, for twelve months",
    "Attend the scheduled reviews",
    "Act on each month's recommendations — or tell us in writing why you're not",
  ],

  measured: [
    "Against the specific goals set at your Path Setup — not your business in general",
    "Using your own numbers, computed the same way every month",
  ...
  finePrint: [
    "Available on + Insights and + Advisor. Not on Your Engine — there's no advisor in the loop to influence the result.",
    "Refund is 50% of recurring fees paid. Setup is excluded; that's work already delivered.",
    "The claim window opens at month 13 and closes at month 15.",
    "One claim per client, per engagement.",
    "At month six we review together. If you're falling short, we fix it then — a refund is the backstop, not the plan.",
    "Definitions are agreed in writing at Path Setup, before anything starts.",
  ],

  why:
    "Most advisors won't do this because they can't measure what they delivered. We can — the engine tracks your goals the same way every month, so there's an agreed number instead of an argument.",
};
